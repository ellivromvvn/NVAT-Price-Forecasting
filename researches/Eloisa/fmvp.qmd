...
4.  Use either ARIMA or ETS model to generate forecasts for monthly prices for each vegetable in Nueva Vizcaya.
...
### Time Series of the Monthly Vegetable Prices in NVAT
...
### ARIMA and ETS Models for the Time Series of Monthly Vegetable Prices
