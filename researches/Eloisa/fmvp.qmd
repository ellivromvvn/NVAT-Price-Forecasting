...
3.  Determine and describe the performance of the optimal model --- whether ARIMA or ETS --- for forecasting monthly prices for each vegetable in Nueva Vizcaya.

4.  Use the optimal ARIMA or ETS model to generate forecasts for monthly prices for each vegetable in Nueva Vizcaya.
