...
The primary source of data for the research is the NVAT. Available time series of vegetable prices from the NVAT will be used to come up with ARIMA or ETS models to forecast monthly vegetable prices.
