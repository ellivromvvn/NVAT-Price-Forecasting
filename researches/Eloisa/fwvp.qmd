...
In response to the problem of volatile vegetable prices faced by local farmers, distributors, and consumers, the researchers will provide forecasts of monthly vegetable prices in Nueva Vizcaya. This will assist them in making informed decisions regarding agricultural production, distribution, and vegetable purchases.
...
2.  Identify the best AutoRegressive Integrated Moving Average (ARIMA) model and Exponential Smoothing (ETS) model for forecasting monthly prices for each vegetable in Nueva Vizcaya.

3.  Determine the better model between ARIMA and ETS for forecasting monthly prices for each vegetable in Nueva Vizcaya.

4.  Forecast monthly prices for each vegetable in Nueva Vizcaya using the better model ARIMA and ETS.
