...
To achieve this, the researchers will use available time series data on vegetable prices from the Nueva Vizcaya Agricultural Terminal (NVAT) to develop models for forecasting monthly vegetable prices in Nueva Vizcaya. Initially, the researchers will define and describe the monthly vegetable prices in Nueva Vizcaya. Subsequently, they will fit models to the data, determining which model exhibits the best forecast performance for each vegetable. Finally, these models will be used to forecast monthly vegetable prices in Nueva Vizcaya.
...
The study will focus on forecasting the monthly prices of vegetables in NVAT, Bambang, Nueva Vizcaya. The researchers will use available time series of vegetable prices from NVAT. From this data, monthly time series of prices for each vegetable will be defined and described. ARIMA and ETS models will then be fitted to the data using automatic algorithms to determine optimal models for each vegetable. Time series cross-validation and a comparison of computed point forecast measures will help identify the model that will be used in forecasting monthly prices for each vegetable.

The researchers will not make adjustments and transformations to the data. Model specifications will not be set either, as this process will be performed automatically using default settings. All computations and visualizations will be performed in the R programming language [@r]. Moreover, external variables impacting vegetable prices will not be investigated nor will be incorporated in the modeling process.

### Conceptual Framework

The research paradigm depicted in @fig-rp will serve as a guide for the researchers throughout the study. It comprises input, process, and output phases. The input involves utilizing available time series data on vegetable prices from NVAT. The output will include ARIMA and/or ETS models along with their corresponding monthly forecasts.
