...
To do this, the researchers will use available time series of vegetable prices from NVAT to come up with models that will forecast monthly vegetable prices in Nueva Vizcaya. First, the researchers will define and describe the monthly vegetable prices in Nueva Vizcaya. Next, the researchers will fit models to the data. The researchers will then determine which model has the the best forecast performance for each vegetable and then them to forecast monthly vegetable prices in Nueva Vizcaya.
